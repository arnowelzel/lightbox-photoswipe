...
= The plugin seems not to work propery =
...
Also keep in mind that images need to be part of the HTML output generated by WordPress. Images which are added using JavaScript after the page has been loaded by the browser will not be displayed with Lightbox with PhotoSwipe.
