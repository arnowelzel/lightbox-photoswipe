...
Also keep in mind that images need to be part of the HTML output generated by WordPress. Images which are added using JavaScript after the page has been loaded already by the browser cannot be displayed with Lightbox with PhotoSwipe.
...
* Image will be visible during opening transition of the lightbox.
