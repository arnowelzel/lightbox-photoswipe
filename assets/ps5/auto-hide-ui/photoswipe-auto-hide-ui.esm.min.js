class PhotoSwipeAutoHideUI{constructor(lightbox,options){this.options={...options};this.captionTimer=!1;this.lightbox=lightbox;this.hasTouch=!1;this.lightbox.on('change',()=>{document.addEventListener('touchstart',()=>{this.stopHideTimer();this.hasTouch=!0},{once:!0})
...
this.stopHideTimer();this.captionTimer=window.setTimeout(()=>{this.hideUI()},5000);document.addEventListener('mousemove',()=>{this.mouseMove()},{once:!0})}
