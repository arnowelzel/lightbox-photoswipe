...
useMobileLayout(){if(this.options.type==='overlay'){return!1}
const{mobileLayoutBreakpoint}=this.options;if(typeof mobileLayoutBreakpoint==='function'){return mobileLayoutBreakpoint.call(this)}else if(typeof mobileLayoutBreakpoint==='number'){if(window.innerWidth<mobileLayoutBreakpoint){return!0}}
return!1}
...
return captionHTML}
updateCaptionHTML(){const captionHTML=this.getCaptionHTML(this.pswp.currSlide);this.captionElement.style.visibility=(captionHTML&&captionHTML!=='<div class="pswp__caption"><div class="pswp__caption__title"></div><div class="pswp__caption__text"></div></div><div class="pswp__caption__exif"></div>')?'visible':'hidden';this.captionElement.innerHTML=captionHTML||'';this.pswp.dispatch('dynamicCaptionUpdateHTML',{captionElement:this.captionElement})}}
