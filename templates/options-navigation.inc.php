<nav class="nav-tab-wrapper" aria-label="<?php echo __('Secondary menu', 'lightbox-photoswipe'); ?>">
    <a href="#" id="lbwps-switch-1" class="nav-tab nav-tab-active" onclick="lbwpsSwitchTab(1);return false;"><?php echo __('Info', 'lightbox-photoswipe'); ?></a>
    <a href="#" id="lbwps-switch-2" class="nav-tab" onclick="lbwpsSwitchTab(2);return false;"><?php echo __('General', 'lightbox-photoswipe'); ?></a>
    <a href="#" id="lbwps-switch-3" class="nav-tab" onclick="lbwpsSwitchTab(3);return false;"><?php echo __('Theme', 'lightbox-photoswipe'); ?></a>
